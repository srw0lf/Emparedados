...
$pedidos="SELECT * FROM Pedidos order by fechaPedido";
$queryPedidos= $conexion->query($pedidos);
	...
	<body>
		...
		<section>
				...
				<table class="table">
				  ...
				  while($registroAlumno  = $queryPedidos->fetch_array) 
				  {


				  echo '<tr>
				    	<td>'.$registroAlumno['idPedido'].'</td>
				    	<td>'.$registroAlumno['direccionPedido'].'</td>
				    	<td>'.$registroAlumno['fechaPedido'].'</td>
